...
import { leastViewedArchivesListSelector } from 'modules/instagram/selector';

const selector = createStructuredSelector({
  archiveStory: leastViewedArchivesListSelector,
});
...
const LeastViewedStoriesScreen = () => {
...
export default LeastViewedStoriesScreen;
